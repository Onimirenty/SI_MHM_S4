...
">
        ...
        <div class="row">
            ...
            <a href="<?php echo site_url('select/Select/facture') ?>">
                        <div class="col-sm-6">
                    <div class="textdiv" style="
...
">
        ...
        <!-- multistep form -->
       <form id="msform" action="<?php echo site_url('insert/Insert/facture')?>" method="POST"><!-- progressbar -->
...
">
            ...
            <!-- fieldsets -->
            <fieldset>
              <h2 class="fs-title">FACTURE DE LA SOCIETE</h2>
              <h3 class="fs-subtitle">Insertion Facture</h3>
        <label for="nom">NumFacture: </label>
              
              <input type="number" name="NumFacture">
           <label for="vendeur">Vendeur: </label>
              <input type="text" name="vendeur">
           <label for="acheteur">Acheteur: </label>
              <input type="text" name="acheteur">
              <!-- eto misy liste deroulante hoan'ilay Contact dia rehefa misafidy dia hidden no alefa -->
            ...
            <fieldset>
              ...
              <h2 class="fs-title">Facture </h2>
        <label for="metier">Mode Payement: </label>
            <select class="form-control" id="ModePayement" name="ModePayement">
                    <option value="Au Comptant(en Espece)">Au Comptant(en Espece)</option>
                    <option value="cheque">cheque</option>
                    <option value="carte banquaire">carte banquaire</option>
                   
                    <option value="En Avoir">En Avoir</option>
                    <option value="Mobile Money">Mobile Money</option>

                   </select>

         <label for="metier">Prix: </label>
...
<input type="button" name="previous" class="previous action-button" value="Previous">
    ...
    <img src="<?php echo $burl ?>assets/js/script.js"></script>
