...
">
        ...
        <!-- multistep form -->
       <form id="msform" action="<?php echo site_url('insert/Insert/Employe')?>" method="POST"><!-- progressbar -->
            
           <ul id="progressbar" style="
    margin-left: 25%;
">
              <li class="active">Information Personnel</li>
              <li>Profile dans L'entreprise</li>
            </ul>
            <!-- fieldsets -->
            <fieldset>
              <h2 class="fs-title">EMPLOYE DE LA SOCIETE</h2>
              <h3 class="fs-subtitle">Insertion Employe</h3>
        <label for="nom">Nom: </label>
           ...
           <label for="prenom">Prenom: </label>
            ...
            <fieldset>
              ...
              <h2 class="fs-title">Profiles de Travail</h2>
              <h3 class="fs-subtitle">Employe</h3>
        ...
        <label for="metier">Metier: </label>
         ...
         <p>Pouvoir Executif dans l'entreprise: </p>
          <input type="hidden" name="idDepartement" value="1">
              
               <input type="hidden" name="idSociete" value="1">
              
            <input type="number" name="pouvoirExecutif">
