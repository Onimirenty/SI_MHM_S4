...
">
    <img src="<?php echo $burl ?>assets/img/images/retour.png" style="width: 45%;">
        ...
        <!-- multistep form -->
       <form id="msform" action="<?php echo site_url('insert/Insert/identite_Entreprise')?>" method="POST"><!-- progressbar -->
       
            <!-- fieldsets -->
            <fieldset>
              <h2 class="fs-title">Mettre a jour les informations sur la SOCIETE</h2>
              <h3 class="fs-subtitle">Information Generale</h3>
         
              <p>Nom Societe</p>
                    <input type="text" name="nomSociete">
                <p>Objet Societe</p>
                <input type="text" name="ObjetSociete">
                <label for="logo">Logo de l'entreprise</label>
                    <input type="file" name="logo" >
               <p>Lieu d'exercice</p>
                 <input type="text" name="LieuExercice">
