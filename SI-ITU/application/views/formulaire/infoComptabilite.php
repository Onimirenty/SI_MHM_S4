...
">
        ...
        <div class="row">
            ...
            <a href="<?php echo site_url('select/Select/infoComptabilite') ?>">
                          <div class="col-sm-6">
                    <div class="textdiv" style="
...
">
        ...
        <!-- multistep form -->
       <form id="msform" action="<?php echo site_url('insert/Insert/infoComptabilite')?>" method="POST"><!-- progressbar -->
            <ul id="progressbar">
              <li class="active" style="
    margin-left: 16%;
">Information Generale</li>

              <li>Exercice Comptable</li>
            </ul>
            <!-- fieldsets -->
            <fieldset>
              <h2 class="fs-title">Mettre a jour les informations sur la SOCIETE</h2>
              <h3 class="fs-subtitle">Mise a jour comptabilité 1</h3>
                  <p>Societe</p>
        <select id="options" name="idSociete"> <?php foreach ($identite_entreprise as $identite_entreprises): ?>


            <option value="<?php echo $identite_entreprises->id ?>"><?php echo $identite_entreprises->nomSociete; ?></option>
           <?php endforeach;?>
        </select>
              ...
              <label for="scanNIF">scan NIF</label>
                    <input type="file" name="scanNIF">
                <label for="STAT">Numero STAT</label>
                <input type="text" name="NSTAT">
                <label for="scanNSTAT">scan STAT</label>
                    <input type="file" name="scanNSTAT">
                <label for="NRCS">NRCS</label>
                <input type="text" name="NRCS">
                <label for="scanNRCS">scan NRCS</label>
                    <input type="file" name="scanNRCS">
              <input type="button" name="next" class="next action-button" value="Next">
            </fieldset>
            <fieldset>

              <h2 class="fs-title">Exercice Comptable</h2>
              <h3 class="fs-subtitle"> Mise a jour comptabilité 2</h3>

              <p>Date début exercice</p>
                <input type="date" name="dateDebut">
                <p>Devise de tenu de compte</p>
                <label for="options">Options:</label>
        <select id="options" name="idDevise"style=" position: relative; left: 10%;    top: -52px;">
             <?php foreach ($devise as $devises): ?>
             <option value="<?php echo $devises->id; ?>"><?php echo $devises->nomDevise; ?></option>
        <?php endforeach;?>


        </select>

        <input type="button" name="previous" class="previous action-button" value="Previous" style="
    margin-left: -29%;
">
