...
">
        ...
        <div class="row">
            ...
            <a href="<?php echo site_url('select/Select/stock') ?>">
                         <div class="col-sm-6">
                    <div class="textdiv" style="
