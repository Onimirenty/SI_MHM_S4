...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="<?php echo $burl ?>/assets/css/style.css">   <link rel="stylesheet" href="<?php echo $burl ?>/assets/fontawesome-5/css/all.min.css">
...
function getButtonLink() {
    if (uri_string() === 'select/Select/Produit') {
        return site_url('Formulaire/Formulaire/produit');
    }
    if (uri_string() === 'select/Select/contact') {
        return site_url('Formulaire/Formulaire/contact');
    }
        if (uri_string() === 'select/Select/facture') {
        return site_url('Formulaire/Formulaire/facture');
    
    }
        if (uri_string() === 'select/Select/employer') {
        return site_url('Formulaire/Formulaire/employer');
    } 
       if (uri_string() === 'select/Select/entreprise') {
        return site_url('Formulaire/Formulaire/entreprise');
    }
    
    
    else {
        return site_url('Formulaire/Formulaire/infoComptabilite'); // Lien sans redirection
    }
}
?>

<div class="col-md-12">
    <a href="<?php echo getButtonLink(); ?>">
        <div class="col-sm-6">
            <div class="textdiv" style="background-color: #c7dbff00;">
                <p style="background: #005397;
                        ...
                        border: none;
                        border-radius: 6px;
                        font-size: 17px;"><i class="fas fa-plus"></i>Ajouter</p>
            </div>
        </div>
    </a>
</div>
