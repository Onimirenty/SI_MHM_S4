...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="<?php echo $burl ?>/assets/css/style.css">
    <link rel="stylesheet" href="<?php echo $burl ?>/assets/css/journal.css">
...
<div class="row">
    ...
    <div class="row">
       <div class="col-md-12">
            <a href="<?php echo site_url('Select/Formulaire/infoComptabilite') ?>"> <div class="col-sm-6">
                <div class="textdiv" style="margin-left: 1126%;width: 128%;">
