...
class Balance extends CI_Model
{
    ...
    /*
        retourne la valeur de la balance depuis lea table transaction
    */
    ...
    /*
        retourne un tableau contenant chaque ligne de la teble 
        transactions en  actualisant le champs balance a chaque entre de ligne 
    */
    ...
    /*
        donne le nom d'un compte a partir de la table intitule_Sous_compte
    */
